	...
	public class TradeProcessor
	{
		public void ProcessTrades(System.IO.Stream stream)
		{
			...
			foreach (var line in lines)
			{
				...
				{
					Console.WriteLine("WARN: Tradeamount on line {0} not a valid integer: '{1}'", lineCount, fields[1]);
				}
				...
				var sourceCurrencyCode = fields[0].Substring(0, 3); var destinationCurrencyCode = fields[0].Substring(3, 3);
