...
namespace SRP2
{
	...
	/// Trade Processor
	/// </summary>
	/// <remarks>Refactored for clarity, this breaks the methods down into single responsibilities.</remarks>
	public class TradeProcessor
	{
		...
		private bool ValidateTradeData(string[] fields, int currentLine)
		{
			...
			{
				LogMessage("WARN: Trade currencies on line {0} not a valid integer: '{1}'", currentLine, fields[1]);
				return false;
			}
